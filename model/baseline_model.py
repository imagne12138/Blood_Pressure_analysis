...
class BaselineModel(nn.Module):
    ...
    #     hidden = (weight.new(self.num_directions * self.num_layers, batch_size, self.hidden_dim).zero_().to(device),
    #               weight.new(self.num_directions * self.num_layers, batch_size, self.hidden_dim).zero_().to(device))
